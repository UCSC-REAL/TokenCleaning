...
# Train_DATASET_LIST=("filtered-cured-50k-rho-baseline-llama3b-global-ref-8binst")
...
do
    ...
    model_tags=("${train_dataset_name}_6")
    # model_tags=("${train_dataset_name}")
    # model_tags=("${train_dataset_name}_5" "${train_dataset_name}_6" "${train_dataset_name}_7" "${train_dataset_name}_8" "${train_dataset_name}_9")

...
token_select_pattern="loss_ranking_select" #'random_semi_shift', 'semi_select', 'random_select', "loss_ranking_select", "all_token_select"
...
# train_data_tag="filtered-cured-50k-rho-baseline-llama3b-global-low-ppl-0.86"
train_data_tag="filtered-cured-50k-rho-baseline-llama3b-global-high-ppl"

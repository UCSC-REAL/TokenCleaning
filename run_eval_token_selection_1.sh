...
Train_DATASET_LIST=("filtered-cured-50k-iter-split-global_data_prop_0.4_llama3b-non-filtered-fixed-base-model" "filtered-cured-50k-iter-split-global_data_prop_0.5_llama3b-non-filtered-fixed-base-model" "filtered-cured-50k-iter-split-global_data_prop_0.9_llama3b-non-filtered-fixed-base-model")
...
# "squad_completion"
# TASK_LISTS=('mmlu' 'bbh' 'gsm8k' "truthfulqa" "hellaswag" "arc_challenge" "openbookqa" "boolq" 'logiqa')

# TASK_LISTS=("sciq" "triviaqa" "piqa" 'arc_easy' 'logiqa' 'winogrande') #"squadv2"
# TASK_LISTS=('logiqa') #"squadv2"
...
do
    ...
    if [[ "$train_dataset_name" == *"0.3"* ]]; then
        data_prop_list=(0.3)
    elif [[ "$train_dataset_name" == *"0.4"* ]]; then
        data_prop_list=(0.4)
    elif [[ "$train_dataset_name" == *"0.5"* ]]; then
        data_prop_list=(0.5)
        ...
        data_prop_list=(0.8)
    elif [[ "$train_dataset_name" == *"0.9"* ]]; then
        data_prop_list=(0.9)
    else

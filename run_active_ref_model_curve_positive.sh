...
train_dataset_name="filtered-cured-50k-active-split-global-curve-positive"
...
# nohup bash run_active_ref_model_curve_positive.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-curve-positive.log &

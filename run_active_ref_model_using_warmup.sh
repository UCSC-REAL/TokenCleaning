...
# reference_model="/mnt/data1/jinlong/token_selection_output/models/${base_model}/data_prop_0.6/lora_merged_filtered-cured-10k-warmup"
...
# Train_DATASET_LIST=("filtered-cured-50k-shuffle-active-split-global-half-positive-fixed-base-loss-using-warmup")

# Train_DATASET_LIST=("filtered-cured-50k-active-split-global-half-positive-fixed-base-loss-using-warmup")
...
# nohup bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-half-positive-new1.log &
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-shuffle_version.log 2>&1
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-0.3-shuffle.log 2>&1
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-curve-positive-reverse.log 2>&1
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-curve-positive-reverse-loss-sum.log 2>&1
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-sample-positive-reverse.log 2>&1
# bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-curve-smooth-positive-reverse.log 2>&1

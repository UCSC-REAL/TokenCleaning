...
Train_DATASET_LIST=("filtered-cured-50k-active-split-global-curve-positive-new1-lr")
...
# nohup bash run_active_ref_model.sh > zzz_llama_3_8b_filtered-cured-50k-active-split-global-curve-positive-new1-lr.log &